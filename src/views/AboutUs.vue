<template>
  <div class="grid-container full">
    ...
    <div class="foreground white">
      ...
      <div class="grid-x">
        <div class="cell small-10 small-offset-1 large-5 large-offset-6">
      ...
      <div class="grid-x">
        <div class="small-10 small-offset-1 cell large-8 large-offset-2">
          <p class="xlarge-text center">We are an investment company with a difference.</p>
        </div>
      </div>
      ...
      <div class="grid-x">
        <div class="small-10 small-offset-1 cell large-3 large-offset-2">
